(function(h) {
    ...
    function Ia(a) {
        ...
        for (f = b.length; e < f; e++)
            if (l = b[e], s = [], !l.sType && l._sManualType) l.sType = l._sManualType;
            else if (!l.sType) {
            g = 0;
    ...
    function Ka(a, b, c, d) {
        var e = [],
            ...
            m = function(a) {
                if (c === k || c === i) j = l[i], n = h.trim(a.innerHTML), j && j._bAttrSrc ? (S(j.mData._)(d, n), s(j.mData.sort, a), s(j.mData.type, a), s(j.mData.filter, a)) : q ? (j._setter || (j._setter = S(j.mData)), j._setter(d, n)) : d[i] = n;
                i++
            };
        if (f)
            for (; f;) {
        ...
        if (-1 !== h.inArray(!1, b)) C(a, !1);
            ...
            if (0 !== i.length) {
                ...
                for (j = j ? 0 : g; j < f; j++) {
                    ...
                    if (0 !== e) {
                        var s = d[c % e];
                        q._sRowStripe != s && (h(l).removeClass(q._sRowStripe).addClass(s), q._sRowStripe = s)
                    }
            ...
            v(a, "aoHeaderCallback", "header", [h(a.nTHead).children("tr")[0], Ma(a), g, n, i]);
            v(a, "aoFooterCallback", "footer", [h(a.nTFoot).children("tr")[0], Ma(a), g, n, i]);
            d = h(a.nTBody);
            d.children().detach();
            d.append(h(b));
    ...
    function nb(a) {
        return a.bAjaxDataGet ? (a.iDraw++, C(a, !0), ta(a, wb(a), function(b) {
            xb(a, b)
        }), !1) : !0
    }
    ...
    function wb(a) {
        ...
        for (g = 0; g < c; g++) n = b[g],
            l = f[g], i = "function" == typeof n.mData ? "function" : n.mData, qa.columns.push({
                data: i,
                name: n.sName,
            ...
            }), s("mDataProp_" + g, i), d.bFilter && (s("sSearch_" + g, l.sSearch), s("bRegex_" + g, l.bRegex), s("bSearchable_" + g, n.bSearchable)), d.bSort && s("bSortable_" + g, n.bSortable);
        ...
        b = m.ext.legacy.ajax;
        return null === b ? a.sAjaxSource ? j : qa : b ? j : qa
    }
    ...
    function zb(a, b, c, d, e, f) {
        if ("" !== b)
            for (var g = a.aiDisplay, d = Ra(b, d, e, f), e = g.length - 1; 0 <= e; e--) b = a.aoData[g[e]]._aFilterData[c], d.test(b) || g.splice(e, 1)
    }
    ...
    function Va(a, b, c) {
        ...
        0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 :
            "previous" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : K(a, 0, "Unknown paging action: " + b, 5);
    ...
    function la(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, Z(a);
            ...
            r && (Q = r.clone().prependTo(o), P = r.find("tr"), Q =
                Q.find("tr"));
            ...
            if ("" === c) {
                v.width = "100%";
                if (U && (o.find("tbody").height() > j.offsetHeight || "scroll" == l.css("overflow-y"))) v.width = t(o.outerWidth() - b);
                f = o.outerWidth()
            } else "" !== d && (v.width = t(d), f = o.outerWidth());
            I(C, L);
            I(function(a) {
                z.push(a.innerHTML);
                Wa.push(t(h(a).css("width")))
            }, L);
            I(function(a, b) {
                if (h.inArray(a, ac) !== -1) a.style.width = Wa[b]
            }, p);
            h(L).height(0);
            r && (I(C, Q), I(function(a) {
                A.push(a.innerHTML);
                y.push(t(h(a).css("width")))
            }, Q), I(function(a, b) {
                a.style.width = y[b]
            }, P), h(Q).height(0));
            I(function(a, b) {
            ...
            if (o.outerWidth() < f) {
                ...
                if (U && (j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y"))) v.width = t(P - b);
                ("" === c || "" !== d) && K(a, 1, "Possible column misalignment", 6)
            } else P = "100%";
            q.width = t(P);
            g.width = t(P);
            r && (a.nScrollFoot.style.width = t(P));
            !e && U && (q.height = t(u.offsetHeight + b));
            c = o.outerWidth();
            n[0].style.width = t(c);
            i.width = t(c);
            d = o.height() > j.clientHeight || "scroll" == l.css("overflow-y");
            e = "padding" + (x.bScrollbarLeft ? "Left" :
                "Right");
            i[e] = d ? b + "px" : "0px";
            r && (m[0].style.width = t(c), s[0].style.width = t(c), s[0].style[e] = d ? b + "px" : "0px");
    ...
    function Ha(a) {
        ...
        for (m = 0; m < i.length; m++) p = c[i[m]], null !== p.sWidth && (p.sWidth = Gb(p.sWidthOrig, k), s = !0);
        if (d || !s && !f && !e && j == ba(a) && j == n.length)
            for (m = 0; m < j; m++) i = $(a, m), null !== i && (c[i].sWidth = t(n.eq(m).width()));
        else {
            ...
            for (m = 0; m < i.length; m++) p = c[i[m]], n[m].style.width = null !== p.sWidthOrig && "" !== p.sWidthOrig ? t(p.sWidthOrig) : "", p.sWidthOrig && f && h(n[m]).append(h("<div/>").css({
                width: p.sWidthOrig,
                margin: 0,
                padding: 0,
                border: 0,
            ...
            if (a.aoData.length)
                for (m = 0; m < i.length; m++) s = i[m], p = c[s], h(Hb(a, s)).clone(!1).append(p.sContentPadding).appendTo(u);
            h("[name]",
                j).removeAttr("name");
            p = h("<div/>").css(f || e ? {
                position: "absolute",
            ...
            for (m = e = 0; m < i.length; m++) k = h(n[m]), g = k.outerWidth() - k.width(), k = o.bBounding ? Math.ceil(n[m].getBoundingClientRect().width) : k.outerWidth(), e += k, c[i[m]].sWidth = t(k - g);
            b.style.width = t(e);
            p.remove()
        }
        l && (b.style.width =
    ...
    function Gb(a, b) {
        if (!a) return 0;
        var c = h("<div/>").css("width", t(a)).appendTo(b || H.body),
            d = c[0].offsetWidth;
        c.remove();
        return d
    }
    ...
    function Lb(a, b, c) {
        var d, e, f = a.aoColumns,
            b = function(b) {
                if (b && b.time) {
                    var i = v(a, "aoStateLoadParams", "stateLoadParams", [a, g]);
                    if (-1 === h.inArray(!1, i) && (i = a.iStateDuration, !(0 < i && b.time < +new Date - 1E3 * i) && !(b.columns && f.length !== b.columns.length))) {
                        ...
                        v(a, "aoStateLoaded", "stateLoaded", [a, g])
                    }
                }
                c()
            };
    ...
    var m = function(a) {
            ...
            this.api = function(a) {
                return a ? new u(za(this[x.iApiIndex])) : new u(this)
            };
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    ib(o);
                    var r = o.oClasses;
                    g.bJQueryUI ? (h.extend(r, m.ext.oJUIClasses, g.oClasses), g.sDom === l.sDom && "lfrtip" === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'), o.renderer) ? h.isPlainObject(o.renderer) &&
                        !o.renderer.header && (o.renderer.header = "jqueryui") : o.renderer = "jqueryui" : h.extend(r, m.ext.classes, g.oClasses);
                    q.addClass(r.sTable);
                    ...
                    null === g.asStripeClasses && (o.asStripeClasses = [r.sStripeOdd, r.sStripeEven]);
                    ...
                    0 !== s.length && (ea(o.aoHeader, s[0]), e = sa(o));
                    if (null === g.aoColumns) {
                        s = [];
                        j = 0;
                        for (i =
                    ...
                    j = 0;
                    for (i = s.length; j < i; j++) Ga(o, e ? e[j] : null);
                    kb(o, g.aoColumnDefs, s, function(a, b) {
                        ka(o, a, b)
                    });
                    if (x.length) {
                        var w = function(a, b) {
                        ...
                        e = function() {
                            ...
                            U.bSort && z(o, "aoDrawCallback", function() {
                                if (o.bSorted) {
                                    ...
                                    v(o, null, "order", [o, a, b]);
                                    Kb(o)
                                }
                            });
                            z(o, "aoDrawCallback", function() {
                                (o.bSorted || y(o) === "ssp" || U.bDeferRender) && xa(o)
                            }, "sc");
                            ...
                            if (b.length === 0 || b.children().length === 0) q.addClass(r.sNoFooter);
                            else if (b.length > 0) {
                                o.nTFoot = b[0];
                            ...
                            else(o.bDeferLoading || y(o) == "dom") && na(o, h(o.nTBody).children("tr"));
                            o.aiDisplay = o.aiDisplayMaster.slice();
                            o.bInitialised = true;
                            n === false && ha(o)
                        };
                    g.bStateSave ? (U.bStateSave = !0, z(o, "aoDrawCallback", ya, "state_save"), Lb(o, g, e)) : e()
                }
            });
            b = null;
            return this
    ...
    h.extend(u.prototype, {
        ...
        filter: function(a) {
            ...
            if (w.filter) b = w.filter.call(this, a, this);
                ...
                for (var c = 0, d = this.length; c <
                    d; c++) a.call(this, this[c], c, this) && b.push(this[c]);
        ...
        iterator: function(a, b, c, d) {
            ...
            for (h = l.length; g < h; g++) {
                var v = new u(l[g]);
                if ("table" === b) f = c.call(v, l[g], g), f !== k && e.push(f);
                else if ("columns" === b || "rows" === b) f = c.call(v, l[g], this[g], g), f !== k && e.push(f);
                else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) {
                    p = this[g];
                    "column-rows" === b && (m = Da(l[g], r.opts));
                    i = 0;
                    for (n = p.length; i < n; i++) f = p[i], f = "cell" === b ? c.call(v, l[g], f.row, f.column, g, i) : c.call(v, l[g], f, g, i, m), f !== k && e.push(f)
                }
            }
            return e.length || d ? (a = new u(l, a ? e.concat.apply([], e) : e), b = a.selector, b.rows = r.rows, b.cols = r.cols, b.opts = r.opts, a) : this
        },
        ...
        unique: function() {
            return new u(this.context, ra(this))
        },
        unshift: w.unshift
    });
    ...
    u.registerPlural = r = function(a, b, c) {
        u.register(a, c);
        u.register(b, function() {
            var a = c.apply(this, arguments);
            return a ===
                this ? this : a instanceof u ? a.length ? h.isArray(a[0]) ? new u(a.context, a[0]) : a[0] : k : a
        })
    };
    p("tables()", function(a) {
        var b;
    ...
    var Vb = function(a, b, c) {
        ...
        if ("ssp" == y(a)) T(a, b);
            ...
            ta(a, [], function(c) {
                oa(a);
                for (var c = ua(a, c), d = 0, e = c.length; d < e; d++) N(a, c[d]);
                T(a, b);
                C(a, !1)
            })
        }
    ...
    p("row.add()", function(a) {
        ...
        var b = this.iterator("table", function(b) {
            return a.nodeName && "TR" === a.nodeName.toUpperCase() ? na(b, a)[0] : N(b, a)
        });
        return this.row(b[0])
    });
    var eb = function(a, b) {
        ...
        var b = cb(b),
            c = this.iterator("table", function(c) {
                    ...
                    return bb("column", e, function(a) {
                        ...
                        var k = typeof a === "string" ? a.match(gc) :
                            "";
                        if (k) switch (k[2]) {
                            case "visIdx":
                            case "visible":
    ...
    r("columns().visible()", "column().visible()", function(a, b) {
        ...
        a !== k && (this.iterator("column", function(c, e) {
            v(c, null, "column-visibility", [c, e, a, b])
        ...
        if (null === b || b === k) return this.iterator("table",
            function(b) {
                ...
                return bb("cell", d, function(a) {
                    ...
                    if (a === null || a === k || c) {
                        ...
                        for (r = g.length; p < r; p++) {
                            ...
                            for (u = 0; u < n; u++) {
                                ...
                                if (c) {
                                    t = f[l];
                                    a(v, B(b, l, u), t.anCells ? t.anCells[u] : null) && m.push(v)
                                } else m.push(v)
                            }
                        }
                        return m
                    ...
                    t = h(a).closest("*[data-dt-row]");
                    return t.length ? [{
                        row: t.data("dt-row"),
                        column: t.data("dt-column")
                    }] : []
                }, b, e)
            });
                        ...
                        for (u = d.length; r < u; r++) {
                            ...
                            if (h.isArray(t)) {
                                ...
                                switch (t) {
                                    ...
                                    case "next":
                                        k = j.sNext;
                                        l = t + (e < f - 1 ? "" : " " + g.sPageButtonDisabled);
                                        break;
                                    case "last":
                                        k = j.sLast;
                                        l = t + (e < f - 1 ? "" : " " + g.sPageButtonDisabled);
